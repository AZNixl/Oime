...
> 早期的工具栏右侧曾是一颗「ThinkPad 小红点」风格的摇杆，后来被 ○ 圆环取代——
> 品牌是 ○，交互也回到"搓球"这件事上，比抽象摇杆更贴。
...
- **横屏分体键盘**（方案 L4）：左右各 5 列、镜像错位、中间留手势空隙，**B 键归右半**；
  竖屏布局与自定义布局互不影响，按屏幕方向自动切换
