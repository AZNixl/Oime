...
> ，该输入法为个人使用输入法，有问题欢迎issues,更好的方式是fork后让AI修改，更快实现你的想法
...
工具栏正中那颗 **○ 圆环**，灵感来自 **BlackBerry 的轨迹球**。
...
- 符号键长按呼出popup可选默认打开九宫格数字键or26键符号键盘
...
到 **[Releases](https://github.com/AZNixl/Oime/releases/latest)** 按 CPU 架构下载对应包：
